...
Summary of available endpoints (see also on /swagger-ui on the server)
...
Endpoints of HMM based tech:
```
/phonemeContrast
/flowspeech/sentenceStress
/flowspeech/wordStress
```

Endpoints of wav2vec based tech:
```
/w2v/contrast/vowel
/w2v/contrast/consonant
/w2v/contrast/termination
/w2v/stress/sentence
/w2v/stress/word
```
