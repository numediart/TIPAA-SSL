...
if check_password():
    ...
    if st.button('Process'):
        ...
        d = st.download_button(
            'Download linguistic data', ling_buf, file_name="linguistic_data.csv"
        ...
        d = st.download_button(
            'Download all phrases data',
            all_sentences_df_buf,
            file_name="all_phrases_df.csv",
        )  # , on_click=on_click_download_zip)  # Defaults to 'application/octet-stream'
        ...
        df.to_csv(df_buf)
        d = st.download_button(
            'Download master sheet data', df_buf, file_name="master_sheet.csv"
        )  # , on_click=on_click_download_zip)  # Defaults to 'application/octet-stream'
        ...
        d = st.download_button(
            'Download potential errors data', df_errors_buf, file_name="errors.csv"
        )  # , on_click=on_click_download_zip)  # Defaults to 'application/octet-stream'
