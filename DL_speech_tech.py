...
def phone_prob_matrix_segmentation(phone_prob_matrix, phoneme_list, model=default_model, unstress=True):
    with CodeTimer('DTW'): 
        if unstress:phoneme_list=remove_stress_annots(phoneme_list)
