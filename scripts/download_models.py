...
def download_hf_model(
    hf_path_base="hf_models", hf_rep='charsiu', hf_model='en_w2v2_fc_10ms'
):
...
download_hf_model(
    ...
    hf_rep="facebook",
    hf_model="wav2vec2-xlsr-53-espeak-cv-ft",
)
download_hf_model(
    hf_path_base=hf_path_base, hf_rep="facebook", hf_model="wav2vec2-base-960h"
)
