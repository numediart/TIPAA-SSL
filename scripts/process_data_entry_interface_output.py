...
select_wrong_ex_type = BE.loc[BE.exercise_type == 'spoken_sentence', 'phrase_data'].apply(
    lambda r: list(r.keys()) != ['question', 'answer']
)
...
with open("scripts/BE_data_entry.json", 'w') as f:
    json.dump(modules, f, indent=2)
