...
- Use a linter and formatter with the Ruff and Black Formatter plugins for VSCode.
...
- Specify the versions of all dependencies in the [env.yml] environment file. This would make it easier to regenerate a lock file whenever we want to update a dependency.
